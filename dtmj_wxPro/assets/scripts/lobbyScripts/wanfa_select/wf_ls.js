...
cc.Class({
    ...
    onLoad() {
        ...
        if (cc.jsInstance.CreatRoomParam.lsparam.round === "round1") {
            self.setCountCheck(true, false, false, false);
        } else if (cc.jsInstance.CreatRoomParam.lsparam.round === "round4") {
            self.setCountCheck(false, true, false, false);
        } else if (cc.jsInstance.CreatRoomParam.lsparam.round === "round8") {
            self.setCountCheck(false, false, true, false);
        } else if (cc.jsInstance.CreatRoomParam.lsparam.round === "circle1") {
    ...
    clickToggle: function(e, custom) {
        ...
        if (self.count1one.isChecked) {
            cc.jsInstance.CreatRoomParam.lsparam.round = "round1";
            cc.jsInstance.CreatRoomParam.lsparam.ls_xg.circle = false;
        }
        if (self.count4one.isChecked) {
            cc.jsInstance.CreatRoomParam.lsparam.round = "round4";
            cc.jsInstance.CreatRoomParam.lsparam.ls_xg.circle = false;
        }
        if (self.count8one.isChecked) {
            cc.jsInstance.CreatRoomParam.lsparam.round = "round8";
            cc.jsInstance.CreatRoomParam.lsparam.ls_xg.circle = false;
        }
        if (self.count1quanone.isChecked) {
            cc.jsInstance.CreatRoomParam.lsparam.round = "circle1";
            cc.jsInstance.CreatRoomParam.lsparam.ls_xg.circle = true;
        }
