...
cc.Class({
    ...
    onLoad() {
        ...
        if (cc.jsInstance.CreatRoomParam.tdh3param.round === "round1") {
            self.setCountCheck(true, false, false);
        } else if (cc.jsInstance.CreatRoomParam.tdh3param.round === "round4") {
            self.setCountCheck(false, true, false);
        } else {
            self.setCountCheck(false, false, true);
        }
        self.baotingone.isChecked = cc.jsInstance.CreatRoomParam.tdh3param.gameXg.needTing;
        self.daifengone.isChecked = cc.jsInstance.CreatRoomParam.tdh3param.gameXg.withWind;
        self.changeTingone.isChecked = cc.jsInstance.CreatRoomParam.tdh3param.gameXg.changeTingGang;

        self.onlyzimoone.isChecked = !cc.jsInstance.CreatRoomParam.tdh3param.gameXg.canEatHu;
        self.dahuone.isChecked = !cc.jsInstance.CreatRoomParam.tdh3param.gameXg.noBigWin;
        // self.pinghuone.isChecked = cc.jsInstance.CreatRoomParam.tdh3param.gameXg.noBigWin;
    ...
    clickToggle: function(e, custom) {
        ...
        if (self.count1one.isChecked) {
            cc.jsInstance.CreatRoomParam.tdh3param.round = "round1";
        }
        if (self.count4one.isChecked) {
            cc.jsInstance.CreatRoomParam.tdh3param.round = "round4";
        }
        if (self.count8one.isChecked) {
            cc.jsInstance.CreatRoomParam.tdh3param.round = "round8";
        }
        cc.jsInstance.CreatRoomParam.tdh3param.gameXg.needTing = self.baotingone.isChecked;
        cc.jsInstance.CreatRoomParam.tdh3param.gameXg.withWind = self.daifengone.isChecked;
        cc.jsInstance.CreatRoomParam.tdh3param.gameXg.changeTingGang = self.changeTingone.isChecked;
        cc.jsInstance.CreatRoomParam.tdh3param.gameXg.canEatHu = !self.onlyzimoone.isChecked;
        cc.jsInstance.CreatRoomParam.tdh3param.gameXg.noBigWin = !self.dahuone.isChecked;
